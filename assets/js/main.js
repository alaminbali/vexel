    ...
    var imJs = {
        ...
        swiperActivation: function (){
          $(document).ready(function() {
            ...
            $(document).ready(function(){
              var swiper = new Swiper(".banner-three-slider-portfolio", {
                slidesPerView: 1,
                speed: 800,
                spaceBetween: 10,
                parallax: true,
        ...
        menuActive:function(){
          ...
          // header top none
          $(document).on('click', '.header-top-start.header-three.header-four .close-icon', function () {
            $(".header-top-start.header-three.header-four").addClass("d-xl-none");
          });

          $(document).on('click', '.header-top-start.header-three .close-icon', function () {
            $(".header-top-start.header-three").addClass("d-xl-none");
          });
        },
        // done
        metismenu:function(){
        ...
        waterJS:function(e){
          ...
          $(document).ready(function() {
            ...
            $('.js-ripples-disable').on('click', function() {
                $('.rts-home-water').ripples('destroy');
                $(this).hide();
            });

            $('.js-ripples-play').on('click', function() {
                $('.rts-home-water').ripples('play');
            });

            $('.js-ripples-pause').on('click', function() {
                $('.rts-home-water').ripples('pause');
            });
